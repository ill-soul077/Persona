    ...
    <nav class="navbar">
        ...
        <div class="mobile-menu">
            <div class="py-2">
                ...
                <a href="#finance" class="block px-4 py-2 hover:bg-[var(--bg-glass-light)]">Finance</a>
                <a href="#tasks" class="block px-4 py-2 hover:bg-[var(--bg-glass-light)]">Tasks</a>
                <a href="{{ route('chatbot') }}" class="block px-4 py-2 hover:bg-[var(--bg-glass-light)]">Chatbot</a>
                <a href="#reports" class="block px-4 py-2 hover:bg-[var(--bg-glass-light)]">Reports</a>
                <a href="#settings" class="block px-4 py-2 hover:bg-[var(--bg-glass-light)]">Settings</a>
            </div>
        </div>
    </nav>
