...
@section('content')
<div x-data="transactionForm({{ json_encode($transaction) }})" x-init="init()">
<!-- Page Header -->
<div class="glass-card rounded-xl p-6 animate-fade-in">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
        <div>
            <h1 class="text-3xl font-bold text-white">Edit Transaction</h1>
            <p class="text-gray-300 mt-2">Update transaction details</p>
        </div>
    </div>
</div>
...
<div class="glass-card rounded-xl p-6 animate-fade-in">
        <form method="POST" 
              action="{{ route('finance.transactions.update', $transaction) }}"
